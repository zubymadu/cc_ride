...
class BookCarInformation extends GetView<BookingDatailsController> {
  const BookCarInformation({super.key});

  @override
  Widget build(BuildContext context) {
    final data = controller.bookTripDetailsApiModel!.tripData!;
    return Container(
      width: Get.width,
