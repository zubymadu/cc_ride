  ...
  static Widget? getCardIcon(CardType? cardType) {
    ...
    switch (cardType) {
      ...
      case CardType.Visa:
        ...
        break;
      case CardType.Verve:
        img = "assets/image/verve.png";
        break;
      case CardType.AmericanExpress:
        img = "assets/image/american_express.png";
        break;
      case CardType.Discover:
        img = "assets/image/discover.png";
        break;
      case CardType.DinersClub:
        img = "assets/image/dinners_club.png";
        break;
      case CardType.Jcb:
        img = "assets/image/jcb.png";
        break;
      case CardType.Others:
        icon = const Icon(Icons.credit_card, size: 20.0, color: ccPrimary);
        break;
      default:
        icon = const Icon(Icons.warning, size: 20.0, color: ccPrimary);
        break;
    }
    Widget? widget;
    if (img.isNotEmpty) {
      widget = Image.asset(img, width: 12);
    } else {
      widget = icon;
    }
    return widget;
